...
public class Gyro : MonoBehaviour
{
    ...
    private bool enableGyro()
    {
        if(SystemInfo.supportsGyroscope)
        {
            ...
            tour.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 0.0f);
            temp = tour.transform.rotation;
            tour.transform.rotation = gyro.attitude;
    ...
    private void Update () {
        ...
        if(gyroOn){
            ...
            tour.transform.rotation = temp * Quaternion.Euler(90.0f, 0.0f, 0.0f) * offset;
        }
    }
